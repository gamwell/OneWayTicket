...
import { supabase } from "../supabaseClient"; // ✔️ Correct
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E3F2FD] to-[#BBDEFB] p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {events.map((event) => (
          <div
            key={event.id}
            className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition p-4"
          >
            <img
              src={event.image_url}
            ...
            <p className="mt-3 font-semibold text-lg text-[#1E88E5]">
              {event.price} €
            </p>
