...
export default function AdminLoginPage() {
  ...
  // ✅ Correction : loginWithGoogle au lieu de signInWithGoogle
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1a0525] p-5 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-purple-500/10 blur-[120px] rounded-full"></div>
      ...
      <div className="relative z-10 bg-white/5 backdrop-blur-2xl p-10 rounded-[2.5rem] shadow-2xl w-full max-w-md border border-white/10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-4xl font-black uppercase italic tracking-tighter text-white">Admin</h2>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          >
            {loading ? <Loader2 className="animate-spin w-5 h-5" /> : 'Connexion Admin'}
          </button>
        </form>
