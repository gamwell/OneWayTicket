        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Link to="/admin/tickets" className="bg-fuchsia-500/10 border border-fuchsia-500/20 p-6 rounded-3xl flex items-center gap-5 hover:bg-fuchsia-500/20 transition-all">
