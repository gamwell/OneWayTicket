      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-medium text-slate-400">
            <li>
              <Link to="/events" className="hover:text-cyan-400 transition-colors flex items-center gap-2">
                <Ticket size={14} /> Événements
              </Link>
            </li>
            <li>
              {/* ✅ Lien À propos */}
            ...
            <li>
              {/* ✅ Lien Mon Compte → bonne route */}
              <Link to="/profile" className="hover:text-cyan-400 transition-colors">Mon Compte</Link>
            </li>
          </ul>
        </div>
